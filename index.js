...
const zooAnimals = [
  ...
  */
  ...
  console.log(`Topic 2b`, lowerCaseNames(zooAnimals));
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    ...
    const smallPop = zooAnimals.filter(function(item){
      return item.population < 5;
    });
    return smallPop;
  }
  
  console.log(`Topic 2c`, lowPopulationAnimals(zooAnimals));
  ...
  */
  ...
  console.log(`Array Step 4`, USApop(zooAnimals));
...
function add(num1, num2){
  ...
  console.log(`Callbacks Step 2`, add(5, 10));
...
console.log(`Callbacks Step2b`, multiply(11, 13));
...
function greeting(firstName, lastName){
  ...
  console.log(`Callbacks Step 3`, greeting("Mary", "Poppins"));
...
console.log(`Prototype Volume`, cuboid.volume()); // 100
 console.log(`Prototype Area`, cuboid.surfaceArea()); // 130
...
console.log(`Classes Area`, cuboidTwo.surfaceArea()); // 130
